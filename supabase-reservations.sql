...
BEGIN
  ...
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'airbnb'::platform_type, '2024-12-31', '2025-01-05', 4, 1494.20, 'EUR', 'confirmed');

  SELECT id INTO v_guest_id FROM guests WHERE owner_id = v_user_id AND name = 'Hamza Taghy';
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'airbnb'::platform_type, '2025-01-29', '2025-02-02', 1, 964.00, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'airbnb'::platform_type, '2025-03-09', '2025-03-12', 2, 771.20, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'airbnb'::platform_type, '2025-03-18', '2025-03-22', 3, 964.00, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'airbnb'::platform_type, '2025-04-09', '2025-04-14', 4, 1446.00, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'airbnb'::platform_type, '2025-05-08', '2025-05-11', 4, 915.80, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'airbnb'::platform_type, '2025-05-21', '2025-05-25', 4, 964.00, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'airbnb'::platform_type, '2025-09-06', '2025-09-09', 4, 1012.20, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'vrbo'::platform_type, '2025-02-20', '2025-02-28', 2, 1654.39, 'EUR', 'confirmed');

  SELECT id INTO v_guest_id FROM guests WHERE owner_id = v_user_id AND name = 'Arman Nahavandifar';
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'vrbo'::platform_type, '2025-04-17', '2025-04-30', 2, 2688.37, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'vrbo'::platform_type, '2025-09-09', '2025-09-16', 2, 2158.38, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'direct'::platform_type, '2025-06-28', '2025-07-08', 4, 2600, 'EUR', 'confirmed');
  ...
  INSERT INTO reservations (owner_id, apartment_id, guest_id, platform, check_in, check_out, guest_count, total_price, currency, status)
  VALUES (v_user_id, v_boccador_id, v_guest_id, 'direct'::platform_type, '2025-08-20', '2025-08-27', 3, 2250, 'EUR', 'confirmed');
